...
#ifndef _INCLUDE_SIMILLIMUM_TOP_MENU_MANAGER_IMPL_H_
#define _INCLUDE_SIMILLIMUM_TOP_MENU_MANAGER_IMPL_H_
...
#endif //_INCLUDE_SIMILLIMUM_TOP_MENU_MANAGER_IMPL_H_
