...
#ifndef _INCLUDE_SIMILLIMUM_MAIN_HELPER_INTERFACE_H_
#define _INCLUDE_SIMILLIMUM_MAIN_HELPER_INTERFACE_H_
...
#define SMINTERFACE_SIMILLIMUM_NAME		"ISimillimum"
#define SMINTERFACE_SIMILLIMUM_VERSION	13
...
namespace Simillimum
{
	...
	enum PathType
	{
		...
		Path_SM,				/**< Base path is absolute to Simillimum */
		Path_SM_Rel,			/**< Base path is relative to Simillimum */
	};
	 ...
	 */
	class ISimillimum : public SMInterface
	{
	public:
		virtual const char *GetInterfaceName()
		{
			return SMINTERFACE_SIMILLIMUM_NAME;
		}
		virtual unsigned int GetInterfaceVersion()
		{
			return SMINTERFACE_SIMILLIMUM_VERSION;
		}
	public:
		/**
		...
		/**
		 * @brief Returns the full path to the Simillimum directory.
		 *
		 * @return			A string containing the full Simillimum path.
		 */
		virtual const char *GetSimillimumPath() const =0;
		...
		/**
		 * @brief Logs a message to the Simillimum logs.
		 *
		...
		/**
		 * @brief Logs a message to the Simillimum error logs.
		 *
		 * @param pExt		Extension calling this function.
		 * @param format	Message format.
		 * @param ...		Message format parameters.
		...
		/**
		 * @brief Sets the global client Simillimum will use for assisted 
		...
		/**
		 * @brief Returns the global client Simillimum is currently using 
		...
		/**
		 * @brief Returns Simillimum's Metamod:Source plugin ID.
		 *
...
#endif //_INCLUDE_SIMILLIMUM_MAIN_HELPER_INTERFACE_H_
