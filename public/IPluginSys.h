...
#ifndef _INCLUDE_SIMILLIMUM_PLUGINMNGR_INTERFACE_H_
#define _INCLUDE_SIMILLIMUM_PLUGINMNGR_INTERFACE_H_
...
namespace Simillimum
{
	...
	/**
	 * @brief Encapsulates a run-time plugin as maintained by Simillimum.
	 */
	class IPlugin
	{
	public:
...
#endif //_INCLUDE_SIMILLIMUM_PLUGINMNGR_INTERFACE_H_
