...
#ifndef _INCLUDE_SIMILLIMUM_IFACE_SHARE_SYS_H_
#define _INCLUDE_SIMILLIMUM_IFACE_SHARE_SYS_H_
...
namespace Simillimum
{
	...
	public:
		...
		/**
		 * @brief Requires an extension.  This tells Simillimum that without this extension,
...
#endif //_INCLUDE_SIMILLIMUM_IFACE_SHARE_SYS_H_
