...
#ifndef _INCLUDE_SIMILLIMUM_FORWARDINTERFACE_H_
#define _INCLUDE_SIMILLIMUM_FORWARDINTERFACE_H_
 ...
 *
 *  Simillimum replaces this forward system with a far more advanced, but a bit bulkier one. The idea is that 
...
#endif //_INCLUDE_SIMILLIMUM_FORWARDINTERFACE_H_
