...
#ifndef _INCLUDE_SIMILLIMUM_TRANSLATOR_INTERFACE_H_
#define _INCLUDE_SIMILLIMUM_TRANSLATOR_INTERFACE_H_
...
namespace Simillimum
{
	...
	/**
	 * @brief Represents a phrase file from Simillimum's "translations" folder.
	 */
	class IPhraseFile
	{
	public:
	...
	public:
		 ...
		 *							This is equivalent to Simillimum's Format() 
...
#endif //_INCLUDE_SIMILLIMUM_TRANSLATOR_INTERFACE_H_
