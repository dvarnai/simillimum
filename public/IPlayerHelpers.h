...
#ifndef _INCLUDE_SIMILLIMUM_INTERFACE_IPLAYERHELPERS_H_
#define _INCLUDE_SIMILLIMUM_INTERFACE_IPLAYERHELPERS_H_
...
{
	/**
	 * @brief Abstracts some Half-Life 2 and Simillimum properties about clients.
	 */
	class IGamePlayer
	{
	public:
	...
	public:
		...
		/**
		 * @brief Gets Simillimum's reply source.
		 *
		...
		/**
		 * @brief Sets Simillimum's reply source.
		 *
...
#endif //_INCLUDE_SIMILLIMUM_INTERFACE_IPLAYERHELPERS_H_
