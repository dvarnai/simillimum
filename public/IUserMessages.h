...
#ifndef _INCLUDE_SIMILLIMUM_INTERFACE_USERMESSAGES_H_
#define _INCLUDE_SIMILLIMUM_INTERFACE_USERMESSAGES_H_
...
namespace Simillimum
{
	...
	#define USERMSG_BLOCKHOOKS			(1<<7)		/**< Prevents the message from triggering Simillimum and Metamod hooks */
...
#endif //_INCLUDE_SIMILLIMUM_INTERFACE_USERMESSAGES_H_
