...
#ifndef _INCLUDE_SIMILLIMUM_INTERFACE_DBDRIVER_H_
#define _INCLUDE_SIMILLIMUM_INTERFACE_DBDRIVER_H_
...
namespace Simillimum
{
	...
	public:
		...
		/**
		 * @brief Given a driver name, attempts to find it.  If it is not found, Simillimum
...
#endif //_INCLUDE_SIMILLIMUM_INTERFACE_DBDRIVER_H_
