...
#ifndef _INCLUDE_SIMILLIMUM_TEXTPARSERS_INTERFACE_H_
#define _INCLUDE_SIMILLIMUM_TEXTPARSERS_INTERFACE_H_
...
extern Simillimum::ITextParsers *textparsers;

#endif //_INCLUDE_SIMILLIMUM_TEXTPARSERS_INTERFACE_H_
