...
#ifndef _INCLUDE_SIMILLIMUM_VERSION_INFORMATION_H_
#define _INCLUDE_SIMILLIMUM_VERSION_INFORMATION_H_

/**
 * @file Contains Simillimum version information.
 * @brief This file will redirect to an autogenerated version if being compiled via
 * the build scripts.
 */

#if defined SM_GENERATED_BUILD
#include <simillimum_version_auto.h>
#else
...
#define SM_VERSION_FILE		1,0,0,0
#endif
#define SM_BUILD_TIMESTAMP	__DATE__ " " __TIME__

#endif /* _INCLUDE_SIMILLIMUM_VERSION_INFORMATION_H_ */
