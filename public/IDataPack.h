...
#ifndef _INCLUDE_SIMILLIMUM_INTERFACE_DATAPACK_H_
#define _INCLUDE_SIMILLIMUM_INTERFACE_DATAPACK_H_
 ...
 * for creating these are contained in ISimillimum.h
 */
...
#endif //_INCLUDE_SIMILLIMUM_INTERFACE_DATAPACK_H_
