...
#ifndef _INCLUDE_SIMILLIMUM_CORECONFIG_H_
#define _INCLUDE_SIMILLIMUM_CORECONFIG_H_
...
private:
	/**
	 * Sets configuration option by notifying Simillimum components that rely on core.cfg
	 */
...
#endif // _INCLUDE_SIMILLIMUM_CORECONFIG_H_
