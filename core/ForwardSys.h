...
#ifndef _INCLUDE_SIMILLIMUM_FORWARDSYSTEM_H_
#define _INCLUDE_SIMILLIMUM_FORWARDSYSTEM_H_
...
class Simillimum::IForwardFilter
{
public:
...
#endif //_INCLUDE_SIMILLIMUM_FORWARDSYSTEM_H_
