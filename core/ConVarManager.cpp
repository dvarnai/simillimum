...
void ConVarManager::OnSimillimumStartup(bool late)
{
	HandleAccess sec;
...
void ConVarManager::OnSimillimumAllInitialized()
{
	/**
 ...
 */
void ConVarManager::OnSimillimumVSPReceived()
{
	/**
...
{
	/* Only check convars that have not been created by Simillimum's core */
	ConVarInfo *pInfo;
