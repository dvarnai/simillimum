...
void TimerSystem::OnSimillimumAllInitialized()
{
...
void TimerSystem::OnSimillimumGameInitialized()
{
...
void TimerSystem::OnSimillimumShutdown()
{
	SetMapTimer(NULL);
...
void TimerSystem::OnSimillimumLevelEnd()
{
	m_bHasMapTickedYet = false;
	m_bHasMapSimulatedYet = false;
}
