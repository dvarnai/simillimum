...
#ifndef _INCLUDE_SIMILLIMUM_MENUMANAGER_H_
#define _INCLUDE_SIMILLIMUM_MENUMANAGER_H_
...
public: //SMGlobalClass
	...
	void OnSimillimumAllShutdown();
	ConfigResult OnSimillimumConfigChanged(const char *key,
		const char *value,
		ConfigSource source,
		char *error,
		size_t maxlength);
	void OnSimillimumLevelChange(const char *mapName);
public: //IMenuManager
...
#endif //_INCLUDE_SIMILLIMUM_MENUMANAGER_H_
