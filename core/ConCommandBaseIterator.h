 ...
 * Version: $Id$
 */
#ifndef _INCLUDE_SIMILLIMUM_CON_COMMAND_BASE_ITERATOR_H_
#define _INCLUDE_SIMILLIMUM_CON_COMMAND_BASE_ITERATOR_H_
...
#endif /* _INCLUDE_SIMILLIMUM_CON_COMMAND_BASE_ITERATOR_H_ */
