...
#ifndef _INCLUDE_SIMILLIMUM_CONCMDMANAGER_H_
#define _INCLUDE_SIMILLIMUM_CONCMDMANAGER_H_
...
struct ConCmdInfo
{
	...
	bool sourceMod;					/**< Determines whether or not concmd was created by a Simillimum plugin */
...
public:
	...
	bool LookForSimillimumCommand(const char *cmd);
...
#endif // _INCLUDE_SIMILLIMUM_CONCMDMANAGER_H_
