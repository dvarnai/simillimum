...
#ifndef _INCLUDE_SIMILLIMUM_PLUGINSYSTEM_H_
#define _INCLUDE_SIMILLIMUM_PLUGINSYSTEM_H_
 ...
 * for execution.  Simillimum is a two pass system, and even though the second pass is not implemented
...
public: //SMGlobalClass
	...
	ConfigResult OnSimillimumConfigChanged(const char *key, const char *value, ConfigSource source, char *error, size_t maxlength);
	void OnSimillimumMaxPlayersChanged(int newvalue);
public: //IHandleTypeDispatch
...
#endif //_INCLUDE_SIMILLIMUM_PLUGINSYSTEM_H_
