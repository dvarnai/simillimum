...
void CPluginManager::OnSimillimumAllInitialized()
{
...
ConfigResult CPluginManager::OnSimillimumConfigChanged(const char *key, 
												 const char *value, 
												 ConfigSource source, 
												 char *error, 
												 size_t maxlength)
...
void CPluginManager::OnRootConsoleCommand(const char *cmdname, const CCommand &command)
{
	...
	/* Draw the main menu */
	rootmenu->ConsolePrint("Simillimum Plugins Menu:");
...
void CPluginManager::OnSimillimumMaxPlayersChanged(int newvalue)
{
