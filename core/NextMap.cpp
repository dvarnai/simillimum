...
void NextMapManager::OnSimillimumAllInitialized_Post()
{
...
void NextMapManager::OnSimillimumShutdown()
{
#if SOURCE_ENGINE >= SE_ORANGEBOX
...
void NextMapManager::OnSimillimumLevelChange( const char *mapName )
{
