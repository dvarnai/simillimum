...
public:
 	static void DelayedActivation(void *inparam)
 	{
 		...
 		{
 			g_Simillimum.AddFrameAction(GenericCommandHooker::DelayedActivation, cdtrs);
 			return;
 		}
...
# endif
		...
		if (!PrepPatch("CGameClient::ExecuteString", "CGC", platform, &cgc))
 		...
 		{
 			g_Simillimum.AddFrameAction(GenericCommandHooker::DelayedActivation, this);
 			return true;
 		}
...
void ConsoleDetours::OnSimillimumAllInitialized()
{
...
void ConsoleDetours::OnSimillimumShutdown()
{
