...
#ifndef _INCLUDE_SIMILLIMUM_CONVARMANAGER_H_
#define _INCLUDE_SIMILLIMUM_CONVARMANAGER_H_
...
/**
 * Holds Simillimum-specific information about a convar
 */
struct ConVarInfo
{
	Handle_t handle;					/**< Handle to self */
	bool sourceMod;						/**< Determines whether or not convar was created by a Simillimum plugin */
...
#endif // _INCLUDE_SIMILLIMUM_CONVARMANAGER_H_
